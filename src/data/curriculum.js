          ...
          lessons: [
            ...
            },
            {
              ...
              items: [
                ...
                { nl: 'Het is half drie.', darija: 'الساعة الجوج ونص', darijaLat: 'sa3a jouj w ness', tip: 'Half drie = 2u30 (halfweg naar drie).' },
                { nl: 'Het is kwart over drie.', darija: 'الساعة تلاتة والربع', darijaLat: 'sa3a tlata w rbe3' },
                { nl: 'Het is kwart voor vijf.', darija: 'الساعة خمسة قل الربع', darijaLat: 'sa3a khamsa qel rbe3' },
                { nl: 'Het is tien uur.', darija: 'العشرة', darijaLat: 'l3echra' },
        ...
        // ---- Module 1.8 — Eten & boodschappen ---------------------------
        {
          ...
          lessons: [
            ...
            },
            {
              ...
              items: [
                { nl: 'groot', darija: 'كبير', darijaLat: 'kbir' },
                { nl: 'klein', darija: 'صغير', darijaLat: 'sghir' },
                { nl: 'goedkoop', darija: 'رخيص', darijaLat: 'rkhis' },
                { nl: 'duur', darija: 'غالي', darijaLat: 'ghali' },
                { nl: 'warm', darija: 'سخون', darijaLat: 'skhoun' },
                { nl: 'koud', darija: 'بارد', darijaLat: 'bared' },
                { nl: 'veel', darija: 'بزاف', darijaLat: 'bezzaf' },
                { nl: 'weinig', darija: 'شوية', darijaLat: 'chwiya' },
                { nl: 'een kilo', darija: 'كيلو', darijaLat: 'kilo' },
                { nl: 'een halve kilo', darija: 'نص كيلو', darijaLat: 'ness kilo' },
                { nl: 'een stuk', darija: 'وحدة / قطعة', darijaLat: 'wehda / qet3a' },
                { nl: 'een fles', darija: 'قرعة', darijaLat: 'qer3a' },
              ],
            },
          ],
        },
          ...
          lessons: [
            {
              ...
              items: [
                { nl: 'ik', darija: 'أنا', darijaLat: 'ana' },
                { nl: 'jij', darija: 'نتا / نتِ', darijaLat: 'nta / nti' },
                { nl: 'u', darija: 'نتا (احترام)', darijaLat: 'nta (beleefd)' },
                { nl: 'hij', darija: 'هو', darijaLat: 'houwa' },
                { nl: 'zij', darija: 'هي', darijaLat: 'hiya' },
                { nl: 'wij', darija: 'حنا', darijaLat: 'hna' },
                { nl: 'jullie', darija: 'نتوما', darijaLat: 'ntouma' },
                { nl: 'zij (meervoud)', darija: 'هوما', darijaLat: 'houma' },
              ],
            },
            {
              id: '1.10.2',
              ...
              darijaNote: '«geen» كتستعمليها مع سمية (geen tijd = ماعنديش الوقت)، «niet» مع الباقي.',
              items: [
                { nl: 'Ik heb geen tijd.', darija: 'ماعنديش الوقت', darijaLat: 'ma3andich lweqt' },
                { nl: 'Ik spreek geen Frans.', darija: 'ماكنهضرش الفرنسية', darijaLat: 'makanhderch lfrancia' },
                { nl: 'Ik versta het niet.', darija: 'مافهمتش', darijaLat: 'mafhemtch' },
                { nl: 'Ik weet het niet.', darija: 'مانعرفش', darijaLat: 'mana3refch' },
                { nl: 'Dat is niet goed.', darija: 'هادا ماشي مزيان', darijaLat: 'hada machi mzyan' },
                { nl: 'Ik heb geen geld.', darija: 'ماعنديش الفلوس', darijaLat: 'ma3andich lflous' },
              ],
            },
            {
              id: '1.10.3',
              ...
              items: [
                { nl: 'het huis → de huizen', tip: '+en' },
                { nl: 'de man → de mannen', tip: '+en (dubbele n)' },
                { nl: 'de vrouw → de vrouwen', tip: '+en' },
                { nl: 'het kind → de kinderen', tip: 'onregelmatig' },
                { nl: 'de tafel → de tafels', tip: '+s (na -el)' },
                { nl: 'de fiets → de fietsen', tip: '+en' },
                { nl: "de auto → de auto's", tip: "+'s" },
                { nl: "de baby → de baby's", tip: "+'s" },
              ],
            },
            {
              id: '1.10.4',
              ...
              darijaNote: '«een» = واحد، غير معروف. «de/het» = المعروف، اللي كتهضري عليه.',
              items: [
                { nl: 'een brood', tip: 'een willekeurig brood' },
                { nl: 'het brood', tip: 'dat specifieke brood' },
                { nl: 'een huis', tip: 'een of ander huis' },
                { nl: 'het huis', tip: 'jouw/dat huis' },
                { nl: 'een man', tip: 'iemand' },
                { nl: 'de man', tip: 'die man' },
                { nl: 'een vraag', tip: 'zomaar een vraag' },
                { nl: 'de vraag', tip: 'die ene vraag' },
              ],
            },
          ],
        },

        // ---- Module 1.11 — In Gent: administratie & nood ----------------
        {
          id: '1.11',
          title: 'In Gent: administratie & nood',
          titleDarija: 'فگاند: الإدارة والطوارئ',
          ...
          lessons: [
            {
              ...
              items: [
                { nl: 'de gemeente', darija: 'البلدية / الكومين', darijaLat: 'lbaladiya / komin' },
                { nl: 'het stadhuis', darija: 'دار البلدية', darijaLat: 'dar lbaladiya' },
                { nl: 'de inburgering', darija: 'الاندماج', darijaLat: 'lindimaj' },
                { nl: 'het document', darija: 'الوثيقة / الورقة', darijaLat: 'lwatiqa / lwrqa' },
                { nl: 'de identiteitskaart', darija: 'البطاقة', darijaLat: 'lbitaqa' },
                { nl: 'de handtekening', darija: 'التوقيع', darijaLat: 'ttewqi3' },
                { nl: 'Ik heb een afspraak bij de gemeente.', darija: 'عندي موعد فالبلدية', darijaLat: '3andi maw3id f lbaladiya' },
                { nl: 'Waar moet ik tekenen?', darija: 'فين خاصني نوقع؟', darijaLat: 'fin khasni nwqe3?' },
                { nl: 'Ik versta het niet, kunt u het herhalen?', darija: 'مافهمتش، واش تقدر تعاود؟', darijaLat: 'mafhemtch, wach tqder t3awed?' },
              ],
            },
            {
              id: '1.11.2',
              ...
              items: [
                { nl: 'VDAB', darija: 'مكتب الشغل (VDAB)', darijaLat: 'werk zoeken', tip: 'Vlaamse dienst om werk te zoeken.' },
                { nl: 'het OCMW', darija: 'المساعدة الاجتماعية', darijaLat: 'sociale hulp', tip: 'Sociale hulp van de gemeente.' },
                { nl: 'de mutualiteit', darija: 'الصندوق ديال الصحة', darijaLat: 'ziekenfonds', tip: 'Je ziekenfonds (terugbetaling dokter).' },
                { nl: 'de huur', darija: 'الكرا', darijaLat: 'lkra' },
                { nl: 'het contract', darija: 'العقد / الكونطرا', darijaLat: 'l3aqd / kontra' },
                { nl: 'de les Nederlands', darija: 'حصة الهولندية', darijaLat: 'hessa d hollandiya' },
              ],
            },
            {
              id: '1.11.3',
              ...
              darijaNote: 'فحالة الطوارئ عيطي على 112. هاد الجمل مهمين بزاف.',
              items: [
                { nl: 'Help!', darija: 'عاونوني!', darijaLat: '3awnouni!' },
                { nl: 'Bel 112!', darija: 'عيط على 112!', darijaLat: '3ayet 3la 112!' },
                { nl: 'Bel de politie!', darija: 'عيط على البوليس!', darijaLat: '3ayet 3la lbolis!' },
                { nl: 'de politie', darija: 'البوليس', darijaLat: 'lbolis' },
                { nl: 'de brandweer', darija: 'البومبيي', darijaLat: 'lbombiy' },
                { nl: 'de ziekenwagen', darija: 'الإسعاف / الأمبولانس', darijaLat: 'lis3af' },
                { nl: 'Er is een ongeval.', darija: 'كاين حادثة', darijaLat: 'kayn hadta' },
                { nl: 'Ik heb hulp nodig.', darija: 'خاصني المساعدة', darijaLat: 'khasni lmosa3ada' },
              ],
            },
            {
              id: '1.11.4',
              ...
              items: [
                { nl: 'Help!', darija: 'عاونوني!' },
                { nl: 'Bel de politie!', darija: 'عيط على البوليس!' },
                { nl: 'Ik heb hulp nodig.', darija: 'خاصني المساعدة' },
                { nl: 'Er is een ongeval.', darija: 'كاين حادثة' },
              ],
            },
          ],
        },
